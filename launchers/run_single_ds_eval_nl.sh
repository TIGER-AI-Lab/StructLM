...
torchrun --nproc_per_node 1 --master_port=$MASTER_PORT eval_llama_stripped.py $kwargs --run_name ${CFG_PREFIX}_${DATASET_NAME} --output_dir output/${CFG_PREFIX}_${DATASET_NAME} --cfg Salesforce/${CFG_PREFIX}_${DATASET_NAME}.cfg --port $LLAMA_PORT --cache_dir "cache_nl"