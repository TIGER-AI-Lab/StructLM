...
# torchrun --nproc_per_node 1 --master_port=1235 eval_llama.py $kwargs --run_name llama2_mmqa --output_dir output/${CFG_PREFIX}_mmqa --cfg Salesforce/${CFG_PREFIX}_mmqa.cfg
# torchrun --nproc_per_node 1 --master_port=1235 eval_llama.py $kwargs --run_name llama2_sql2text --output_dir output/${CFG_PREFIX}_sql2text --cfg Salesforce/${CFG_PREFIX}_sql2text.cfg
# torchrun --nproc_per_node 1 --master_port=1237 eval_llama.py $kwargs --run_name llama2_dart --output_dir output/${CFG_PREFIX}_dart --cfg Salesforce/${CFG_PREFIX}_dart.cfg
...
torchrun --nproc_per_node 1 --master_port=1237 eval_llama.py $kwargs --run_name llama2_sqa --output_dir output/${CFG_PREFIX}_sqa --cfg Salesforce/${CFG_PREFIX}_sqa.cfg
...
# torchrun --nproc_per_node 1 --master_port=1237 eval_llama.py $kwargs --run_name llama2_webqsp --output_dir output/${CFG_PREFIX}_webqsp --cfg Salesforce/${CFG_PREFIX}_webqsp.cfg
